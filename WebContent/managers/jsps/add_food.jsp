...
<body>
	...
	<form action="<%=request.getContextPath() %>/foodController" method="get">
		<input type="hidden" value="insertdata" name="type">
		
		
		<table>
			<tr>
				<td>菜肴名称</td><td><input type="text" name="food_name" ></td>
			</tr>
			
			<tr>
				<td>价格</td><td><input type="text" name="food_price" ></td>
			</tr>
			<tr>
				<td>供应时间段</td><td><input type="text" name="food_time" ></td>
			</tr>
			<tr>
				<td>菜肴种类</td><td><input type="text" name="food_type" ></td>
			</tr>
